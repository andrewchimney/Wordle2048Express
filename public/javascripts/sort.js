let list = require("../wordlists/wordlist234.json");
const fs = require('fs')
...
for(let i=0;i<list.wordlist.length-1;i++){
    ...
    // }
    if(list.wordlist[i].length==4){
        newList.wordlist.push(list.wordlist[i])
    }
}
//}
...
fs.writeFileSync('../wordlists/wordlist4.json', JSON.stringify(newList));
